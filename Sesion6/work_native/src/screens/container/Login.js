...
import { View, Text, TextInput, StyleSheet, SafeAreaView, ImageBackground, Image, TouchableOpacity, Alert } from 'react-native';
...
const Login = () => {
    ...
    function login(emailUser, passwordUser) {
        //Login exitoso
        setLoading(false);
        navigation.navigate('Home',  { email: emailUser});
    }
